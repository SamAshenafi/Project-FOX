...
void Game::run() {
  ...
  while (!WindowShouldClose()) {
    if (gameState == START_MENU) {
      ...
      // for this part of the prototype, the game will skip to the mode battla like it was just initiated
      // also intempted to add the files from input-testing
      ...
      // in thet full build playerParty will pull from whatever  contains the files for the party
